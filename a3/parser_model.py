...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        t_look = self.pretrained_embeddings(t)
        batch_size = t_look.size()[0]
        x = t_look.view(batch_size, -1)
    ...
    def forward(self, t):
        ...
        self.hidden = F.relu(self.embed_to_hidden(self.embedding_lookup(t)))
